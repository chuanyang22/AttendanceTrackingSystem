...
namespace AttendanceTrackingSystem.Migrations
{
    ...
    [Migration("20260902063431_UpdateLeaveApplicationForTeacher")]
    partial class UpdateLeaveApplicationForTeacher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AttendanceTrackingSystem.Models.LeaveApplication", b =>
                {
                    ...
                    b.Property<string>("ProofDocumentFileName")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("AttendanceTrackingSystem.Models.LeaveApplication", b =>
                {
                    b.HasOne("AttendanceTrackingSystem.Models.User", "ReviewedByUser")
                        .WithMany()
                    ...
                    b.HasOne("AttendanceTrackingSystem.Models.User", "ApplicantUser")
                        .WithMany()
